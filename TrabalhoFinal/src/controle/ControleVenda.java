...
/*
  ...
  */  
    public void cadastraVenda(double valorReal, String nomeComprador, Calendar dataVenda,String nomeCorretor, double valorNegociado) throws Exception  {//abre cadastraVenda
        
        listaVendasRealizadas.add(new Venda(valorReal, nomeComprador, dataVenda, nomeCorretor, valorNegociado));
        //grava em arquivo
    ...
    public ArrayList<String> listarVendas() {//abre listarImoveis
        ...
        //listar todos os tipos de imoveis cadastrados
            for (Venda ven : listaVendasRealizadas) {//abre for 01
                ...
                aux = "Nome comprador: " + ven.getNomeComprador() + "\nData Venda: " + ven.getDataVenda() + 
                      "\nCorretor: " + ven.getCorretorResponsavel() + "\nValor Real: " + ven.getValorReal() +
