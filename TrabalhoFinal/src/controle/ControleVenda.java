...
/*
  ...
  */  
    public void cadastraVenda(String nomeComprador, Date dataVenda, String corretorResponsavel, double valorNegociado, Imovel objImovel) throws Exception  {//abre cadastraVenda
        //pega a lista de imóveis
        ctrPrincipal.ctrImovel.getLista();
        ...
        //listar todos os tipos de imoveis cadastrados
            for (Venda ven : listaVendasRealizadas) {//abre for 01
                ...
                aux = "Nome do comprador: " + ven.getNomeComprador() + "\nData Venda: " + ven.getDataVenda() + 
                      ...
                      "\nCódigo imóvel: " + ven.getObjImovel().getCodigo() +
                      "\nTipo: "   + ven.getObjImovel().getTipo() +
                      "\nDescrição: " + ven.getObjImovel().getDescricao();
